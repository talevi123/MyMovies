...
import com.tal.mymovies.Adapters.NavDrawerListAdapter;
...
public class Main2Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navDrawerItems.add(new NavDrawerItem(navMenuTitles[1], R.drawable.ic_search));

        navDrawerItems.add(new NavDrawerItem(navMenuTitles[2], R.drawable.ic_movie, true, "22"));
